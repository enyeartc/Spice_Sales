...
A list of recipies was loaded into a pandas dataframe Using a list of 30,000 recipies most were pulled from https://www.kaggle.com/hugodarwood/epirecipes but several thousand were pulled via a webscraper.  A sample recipe is below.  
